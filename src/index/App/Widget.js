...
export default class Widget extends Component {
    ...
    convertProps = () => {
        return {
            showHideOnChange: this.props.showHideOnChange === 'true' || this.props.showHideOnChange == true,
            ...
            fetch(`https://api.songify.rocks/v2/canvas/${fullSong.song_id}`)
                ...
                .then(canvas => {
                    if (canvas && canvas !== "No canvas found") {
                        // If canvas is found, update the logo with the canvas URL
                        canvas = canvas.replace(/"/g, ''); // Clean up any quotes
    ...
    render() {
        ...
        return (
            ...
            >
                ...
                <div className="title" style={{ left: this.props.position === "right" ? 20 : 70 }}>
                    Now Playing:
                </div>
